...
import com.wanda.fangke.instagram.adapter.GlobalMenuAdapter;
import com.wanda.fangke.instagram.utils.CircleTransformation;
...
public class GlobalMenuView extends ListView implements View.OnClickListener {
    ...
    private void setupHeader(){
        ...
        Picasso.with(getContext()).load(profilePhoto)
